...
import com.ysc.config.Configuration;
import com.ysc.config.TrimProperties;
...
public class Options extends Configuration {
  ...
  static {
    try {
      Class.forName(RpcClientOption.class.getName());
      Class.forName(RpcServerOption.class.getName());
  ...
  @Override
  public void load(final TrimProperties properties) {
